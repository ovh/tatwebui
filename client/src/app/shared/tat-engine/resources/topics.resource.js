...
angular.module('TatUi').service('TatEngineTopicRsc', function($resource) {
    ...
    return $resource('tatengine/topic/:action', { }, {
        ...
        removeAdminUser: {
            method: 'PUT',
            isArray: false,
            params: {action:'remove/adminuser'}
        },
        ...
        removeAdminGroup: {
            method: 'PUT',
            isArray: false,
            params: {action:'remove/admingroup'}
        },
        ...
        removeParameter: {
            method: 'PUT',
            isArray: false,
            params: {action:'remove/parameter'}
        },
