 ...
 */
angular.module('TatUi').controller('UserSignupCtrl', function($scope, $state,
  appConfiguration, Authentication, TatEngine, TatEngineSystemRsc) {
  'use strict';
  ...
  $scope.signup = function() {
    Authentication.signup($scope.user.username, $scope.user.fullname,
      $scope.user.email).then(
      function(data) {
